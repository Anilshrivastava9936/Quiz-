...
# from random import
conn=my.connect(host="localhost",user="root",password="Anil@9936",database="quizz")
cur=conn.cursor()
 ...
 while True:
    ...
    if len(password)>= 8 and len(password)<=20:
        ...
        if l>0 and u>0 and d>0 and s>0:
             ...
             print("plrase use 1 digit,1 special symbal,1 upper_case,1 lower_case Ex.___Anil@123___")
             False
    else:
